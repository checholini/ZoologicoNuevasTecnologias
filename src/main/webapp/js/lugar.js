    ...
    $(document).ready(function (event) {
        $.ajax({
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                var botonActualizar = $('<a href="/ZoologicoNuevasTecnologias/forms/crearLugar.html?id='+ data[i].idLugar+'">').addClass('btn btn-primary');//poner la id de la tabla o entidad
