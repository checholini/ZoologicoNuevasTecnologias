(function ($) {
    ...
    if (getUrlParameter('id')) {
        $.ajax({
            ...
            url: '/ZoologicoNuevasTecnologias-develop/api/documento/' + getUrlParameter('id'),
            ...
            $('#CrearBoton').text("Actualizar").click(function (event) {
              console.log(id);
                $.ajax({
                    method: 'PUT',
                    //Cambiar Ruta al servicio necesitado
                    url: '/ZoologicoNuevasTecnologias-develop/api/documento/' + id,
                    contentType: 'application/json',
                    dataType: 'json',
                    ...
                    window.location.href = '/ZoologicoNuevasTecnologias-develop/documento.html';
